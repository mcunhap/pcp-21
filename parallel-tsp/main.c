...
void* execute(void* arg) {
  ...
  EvaluateTours(my_stack, graph_t, best_tour, execute_mutex, term_t, n_cities, HOMETOWN, NUM_THREADS);

  pthread_exit(NULL);
}

int main(void) {
  /* int n_process, rank_process; */
  ...
  /* printf("Rank: %d, n_cities: %d\n", rank_process, n_cities); */
